...
assert_contains "$ROOT_DIR/skills/create-report/SKILL.md" "do not search local directories for source data files"
...
assert_contains "$ROOT_DIR/skills/create-report/references/report-skill-contract.md" "Do not inspect local source data directories before wizard import output exists."
assert_contains "$ROOT_DIR/skills/create-report/agents/openai.yaml" "Before wizard import output is available, do not search local directories"
